...
class SimulationTest {
    ...
    @Property
    fun testConservationOfEnergy(
        @ForAll @IntRange(min = 2, max = 5) size: Int,
    ...
    @Property
    fun testSymmetry(
        @ForAll @IntRange(min = 3, max = 5) size: Int,
    ) {
    ...
    @Property
    fun testSimStateConsistency(
        @ForAll @IntRange(min = 1, max = 10) length: Int,
    ...
    @Property
    fun testVaryingGridAspectRatios(
        @ForAll @IntRange(min = 1, max = 20) l: Int,
