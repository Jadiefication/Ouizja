...
class LargeGridTemperatureTest {
    private fun getIndex(x: Int, y: Int, height: Int): Int = x * height + y
    ...
    fun testLargeGridReproduction() {
        ...
        assertEquals(Material.STONE.id, actualMaterialId, "Material at (64, 64) should be STONE, but was $actualMaterial (id=$actualMaterialId)")
